        ...
        while (flg) {
            try {
                ...
                if (!(taskName.length() <= 10)) {
                    System.out.println("商品名は10文字以内で入力してください");
                    System.out.println();
                    continue;
                }
    ...
    public void inputChangeInformation() {
        ...
        while (flg) {
            try {
                ...
                String chageTaskCode = reader.readLine();
                if (!isNumeric(chageTaskCode)) {
                    System.out.println("コードは半角の数字で入力してください");
                    System.out.println();
                    continue;
                }
                ...
                switch (selectedSubMenu) {
                    case "1":
                        ...
                        break;
                    case "2":
                        taskLogic.changeStatus(Integer.parseInt(chageTaskCode), 2, loginUser);
                        break;
                    default:
