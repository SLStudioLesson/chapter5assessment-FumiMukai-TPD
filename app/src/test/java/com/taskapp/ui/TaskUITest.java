 ...
 * when(userLogic.login("test@example.com", "password")).thenReturn(new User(0,
 * null, null, null));
 * taskUI.inputLogin();
 * 
 ...
 * doNothing().when(taskLogic).save(1, "Tst Task", 1, new User(0, null, null,
 * null));
 ...
 * doNothing().when(taskLogic).changeStatus(1, 1, new User(0, null, null,
 * null));
